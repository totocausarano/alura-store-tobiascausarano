#  Análisis de Rendimiento - Tiendas Alura Latam

Este proyecto es parte de un análisis de negocio, donde se evaluaron métricas de facturación, ventas y satisfacción del cliente de cuatro sucursales distintas.

El objetivo principal fue identificar patrones de rendimiento y responder a la pregunta estratégica: **¿Cuál de las 4 tiendas debería venderse (desinversión) para optimizar el negocio?**

##  Descripción del Proyecto
En este repositorio encontrarás un análisis de datos donde comparé el desempeño de las tiendas basándome en:
* **Ingresos Totales:** Cuánto dinero generó cada local.
...
**¿Por qué?**
Es la tienda con menor rendimiento financiero y su mix de productos no genera márgenes tan altos como las otras sucursales. Esto la convierte en la opción más lógica.
